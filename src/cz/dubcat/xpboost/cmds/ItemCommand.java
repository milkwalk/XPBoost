	...
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
		...
		if (args.length == 4) {
			...
			ItemStack item = new ItemStack(
					Material.getMaterial(Main.getPlugin().getConfig().getString("settings.itemmaterial")));
			ItemMeta meta = item.getItemMeta();

			meta.setDisplayName(MainAPI.colorizeText(Main.getLang().getString("lang.itemname")

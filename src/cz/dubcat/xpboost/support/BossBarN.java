		...
		for(Player p : Bukkit.getServer().getOnlinePlayers()){
			...
			if(xpbAPI.hasBoost(id)){
				...
				BossBarAPI.addBar(p, // The receiver of the BossBar
	      		      ...
	      		      BossBarAPI.Color.valueOf(Main.getPlugin().getConfig().getString("settings.bossbar.color")), // Color of the bar
	      		      BossBarAPI.Style.valueOf(Main.getPlugin().getConfig().getString("settings.bossbar.style")), // Bar style

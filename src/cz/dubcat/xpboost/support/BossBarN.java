...
public class BossBarN extends BukkitRunnable {
    ...
    public void run() {
        ...
        if (!XPBoostMain.getPlugin().getConfig().getBoolean("settings.bossbar.bossbarmsg")) {
            return;
        }
        ...
        for (Player p : Bukkit.getServer().getOnlinePlayers()) {
            ...
            if (XPBoostAPI.hasBoost(id)) {
                ...
                BossBarAPI.addBar(p, // The receiver of the BossBar
                        ...
                        BossBarAPI.Color.valueOf(XPBoostMain.getPlugin().getConfig().getString("settings.bossbar.color")), // Color
                                                                                                                    // of
                                                                                                                    // the
                                                                                                                    // bar
                        BossBarAPI.Style.valueOf(XPBoostMain.getPlugin().getConfig().getString("settings.bossbar.style")), // Bar
                                                                                                                    // style
